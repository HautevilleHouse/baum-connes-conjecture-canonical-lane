# Constant Extraction Spec (BC)
    ...
    ## Formula Set
    - `kappa_analytic_raw = c_analytic_raw * assembly_density_raw - e_analytic_raw`
- `sigma_equivariant_raw = equivariant_floor_raw - operator_loss_raw - restart_loss_raw`
...
- `sigma_star_can_raw = sigma_star_can_raw`
    ...
    ## Validations
    - positivity required for: `kappa_analytic`, `sigma_equivariant`, `kappa_compact`, `rho_rigidity`, `assembly_transfer`, `sigma_star_can`
