...
Canonical Lane research workspace for a flagship problem in operator K-theory, noncommutative geometry, and geometric group theory:
proving persistence of the topological-to-analytic assembly package through an admissible operator-theoretic closure architecture.

## Main Manuscript

- [paper/BAUM_CONNES_CONJECTURE_PREPRINT.md](paper/BAUM_CONNES_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `BAUM_CONNES_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/BAUM_CONNES_CONJECTURE_PREPRINT.md`.
...
Current BC runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/bc_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/bc_closure_guard.py`.
...
- Manuscript target: [paper/BAUM_CONNES_CONJECTURE_PREPRINT.md](paper/BAUM_CONNES_CONJECTURE_PREPRINT.md)
